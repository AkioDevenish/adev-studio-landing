        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-16 border-b border-foreground/10 pb-8">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`px-6 py-2 text-xs font-mono uppercase tracking-widest transition-all duration-300 border-b-2 ${
                activeTab === "developer"
            ...
            >
              ...
              <div className="w-full md:w-2/5 space-y-6">
                ...
                <div className="flex gap-4">
                  {project.comingSoon ? (
                    <span className="text-sm border-b pb-1 pt-4 border-foreground/10 text-foreground/40 cursor-not-allowed">
                      Coming Soon
                    </span>
                  ) : (
                    <Link
                      href={`/case-study/${project.slug}`}
                      className="text-sm border-b pb-1 pt-4 transition-colors border-foreground/20 hover:border-foreground"
                    >
                      View Details
                    </Link>
                  )}
